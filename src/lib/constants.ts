...
export const PROJECTS: ProjectConfig[] = [
  ...
  },
  {
    ...
    category: 'running',
    deployUrl: 'https://telegram-event-bot-production-5421.up.railway.app',
    platform: 'windows',
  ...
  },
  {
    ...
    repo: 'openclaw-bot',
    description: '텔레그램→Claude Code 워치봇 (OpenClaw 전환 후 모니터링 전용)',
  ...
  },
  {
    ...
    port: 8787,
    phase: '대시보드 관제형 UX 완료',
    completionPct: 65,
    nextTasks: ['실전 페이퍼 트레이딩 검증', 'walk-forward 자동화'],
    priority: 'medium',
  },
  {
    name: 'AI Hub',
